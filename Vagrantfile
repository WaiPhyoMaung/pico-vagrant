...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "nginx" do |nginx_vm|
    nginx_vm.vm.box = "tknerr/baseimage-ubuntu-22.04"  # Adjust if needed
  ...
  config.vm.define "db" do |db_vm|
    db_vm.vm.box = "tknerr/baseimage-ubuntu-22.04"  # Adjust if needed
  ...
  config.vm.define "ansible" do |ansible_vm|
    ansible_vm.vm.box = "tknerr/baseimage-ubuntu-22.04"  # Adjust if needed
